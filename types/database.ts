  ...
  public: {
    Tables: {
      ...
      shortlist: {
        ...
        Relationships: [
          {
            foreignKeyName: "shortlist_target_coach_id_fkey"
          ...
          {
            foreignKeyName: "shortlist_target_listing_id_fkey"
      ...
      swipes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "swipes_target_coach_id_fkey"
            columns: ["target_coach_id"]
            isOneToOne: false
            referencedRelation: "coach_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "swipes_target_listing_id_fkey"
            columns: ["target_listing_id"]
            isOneToOne: false
            referencedRelation: "job_listings"
            referencedColumns: ["id"]
